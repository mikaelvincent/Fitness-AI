...
return [
    ...
    "ascii" =>
        "The :attribute may only contain single-byte alphanumeric characters and symbols.",
    ...
    "doesnt_end_with" =>
        "The :attribute may not end with any of the following: :values.",
    "doesnt_start_with" =>
        "The :attribute may not start with any of the following: :values.",
    ...
    "missing_if" =>
        "The :attribute field must be absent when :other is :value.",
    "missing_unless" =>
        "The :attribute field must be absent unless :other is :value.",
    "missing_with" =>
        "The :attribute field must be absent when :values are present.",
    "missing_with_all" =>
        "The :attribute field must be absent when :values are present.",
    ...
    "password" => [
        ...
        "uncompromised" =>
            "The provided :attribute has appeared in a data breach. Please choose a different :attribute.",
    ],
    ...
    "required_with_all" =>
        "The :attribute field is required when :values are present.",
    "required_without" =>
        "The :attribute field is required when :values are absent.",
